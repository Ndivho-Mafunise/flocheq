      ...
      >
        ...
        <div>
          ...
          <h1 className="text-[40px] font-bold leading-[1.08] mb-4" style={{ letterSpacing: "-0.025em", color: "#fff" }}>
            Collect payments.<br />
            <span style={{ color: "#a5b4fc" }}>Grow faster.</span>
          </h1>
        ...
        <div className="absolute bottom-12 left-12 flex gap-9">
          <div>
            <p className="text-[26px] font-bold text-white" style={{ letterSpacing: "-0.02em" }}>$447K</p>
            <p className="text-[12px]" style={{ color: "rgba(255,255,255,0.6)" }}>tracked this quarter</p>
          </div>
          <div>
            <p className="text-[26px] font-bold text-white" style={{ letterSpacing: "-0.02em" }}>1,284</p>
            <p className="text-[12px]" style={{ color: "rgba(255,255,255,0.6)" }}>active clients</p>
          </div>
        </div>
      </div>
