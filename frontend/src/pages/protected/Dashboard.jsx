...
export default function Dashboard() {
  // ── Auth (matches your pattern exactly) ──────────────────────
      ...
      <aside className="w-[220px] shrink-0 flex flex-col border-r bg-background overflow-y-auto">
        ...
        <div className="px-3 py-2.5">
          <button className="w-full flex items-center gap-2 px-2.5 py-1.5 rounded-md border bg-muted/40 hover:bg-muted transition-colors text-muted-foreground">
            ...
            <kbd className="text-[10px] bg-background border rounded px-1 py-0.5 font-mono text-muted-foreground">
              /
            </kbd>
          </button>
        </div>
          ...
          {navSections.map((section) => (
            <div key={section.heading ?? "__top"}>
              ...
              <div className="space-y-0.5">
                {section.items.map(
                  ({ id, label, icon: Icon, badge, shortcut }) => {
        ...
        <div className="px-2 py-3 space-y-0.5">
          ...
          {/* Logout button — wired to handleLogout */}
          <button
          ...
          {/* User row — driven by useAuthStore user */}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="border-b bg-background px-6 py-3 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-3">
            {/* Welcome message — driven by useAuthStore user */}
            ...
            <Button
              size="sm"
              className="text-[12px] h-7 bg-indigo-600 hover:bg-indigo-700"
            >
              + New report
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-3">
            ...
            <Card className="xl:col-span-2 shadow-none border">
              <CardHeader className="px-5 py-3.5 flex flex-row items-center justify-between border-b">
                ...
                <Button
                  variant="link"
                  className="text-[12px] h-auto p-0 text-indigo-600"
                >
                  View all →
                </Button>
              </CardHeader>
